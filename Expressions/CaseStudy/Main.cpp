// This program calculates the volume, cost, customer charge,
// and profit of a crate of any size. It calculates this data
// from user input, which consists of the dimensions of the crate.
...
int main(int argc, char const *argv[]) {
	...
	const double CHARGE_PER_CUBIC_FOOT = .50;
	...
	double length,  // The crate's length
			...
			charge, // The customers charge for the crate
